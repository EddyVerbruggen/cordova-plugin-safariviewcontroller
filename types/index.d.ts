...
interface SafariViewController {
   ...
   */
  hide(onSuccess?: () => void, onError?: (error: any) => void): void;
   ...
   * @param onError The callback function to call in case of an error or if method is unsupported on current platform.
   */
  connectToService(onSuccess?: (result: true) => void, onError?: (error: any) => void): void;
   ...
   * @param onError The callback function to call in case of an error or if method is unsupported on current platform.
   */
  warmUp(onSuccess?: (result: true) => void, onError?: (error: any) => void): void;
